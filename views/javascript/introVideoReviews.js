...
fetchApiData(numberOfUsers);

function fetchApiData(loadNumber) {
  fetch(
...
function data(json) {
  ...
  numberOfUsers += userReviewsArray.length - 1;
  ...
  for (let index in userReviewsArray) {
    ...
    commentDesc.innerHTML =
      "I really had an amazing and fun time with this course. I find comfort in the instructor way of teaching being light yet noteworthy." +
