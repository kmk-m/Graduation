...
const EmojiPicker = function (options) {
  ...
  const functions = {
    ...
    render: (e, attr) => {
      ...
      //.log(document.querySelector(".fg-emoji-container"));
      document
        .querySelector(".fg-emoji-container")
        .setAttribute("id", "emoContainer." + xy);
  ...
  const bindEvents = () => {
    ...
    //.log("operations");
    this.lib(
      document.getElementById("btn.6b51e5d4-4c0b-11ed-a729-0045e21c18f1")
    ).on("click", functions.render, this.trigger);
