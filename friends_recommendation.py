...
def recommend_friends(active_user_interests, key_list, values_list):
    ...
    for i in values_list:
        match_interests = [
            value for value in active_user_interests if value in i]
        recommended_users.append(
            [key_list[values_list.index(i)], len(match_interests)])
...
recommended_users = recommend_friends(
    active_user_interests, key_list, values_list)
